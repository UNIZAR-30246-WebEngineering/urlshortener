...
1. **Programming Language**: [Kotlin 2.4.0](https://kotlinlang.org/) on **Java 25 LTS**
...
2. **Build System**: [Gradle 9.6](https://gradle.org/)
...
3. **Framework**: [Spring Boot 4.1.0](https://docs.spring.io/spring-boot/) / **Spring Framework 7.0.8**
