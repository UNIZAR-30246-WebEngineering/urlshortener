...
- **README automation**: `readme.yml` renders `README.qmd` ➜ `README.md` with Quarto and commits changes on `main`

## 📝 Changelog

- 2025-10-20: CI updated to Gradle actions v3; detekt reports configured; tests run via `test` and artifacts via `assemble`; added Quarto-based README auto-render workflow; Gradle configuration cache and parallelism enabled.
